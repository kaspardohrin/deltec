jQuery(function ($) {
  ...
  function fetchNewQuote() {
    ...
    renderQuote({ title: 'Victor Papanek', content: '<p>Any attempt to separate design, to make it a thing-by-itself, works counter to the inherent value of design as the primary, underlying matrix of life.</p>\n' })
